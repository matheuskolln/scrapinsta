...
from selenium.webdriver.common.html5.application_cache import (
    ApplicationCache as ApplicationCache,
)

from .command import Command as Command
from .errorhandler import ErrorHandler as ErrorHandler
from .file_detector import (
    FileDetector as FileDetector,
    LocalFileDetector as LocalFileDetector,
)
...
class WebDriver:
    ...
    def file_detector_context(
        self, file_detector_class, *args, **kwargs
    ...
    w3c: Any
    def start_session(
        self, capabilities, browser_profile: Any | None = ...
    ) -> None: ...
